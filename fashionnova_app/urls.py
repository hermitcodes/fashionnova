...
urlpatterns = [
   ...
   path('process-mpesa/<int:order_id>/', views.process_mpesa_payment, name='process_mpesa_payment'),
    ...
    # AI Stylist API
    path('api/analyze-image/', views.analyze_product_image_view, name='ai_analyze_image'),
    path('api/chat-styling/', views.ai_stylist_chat_view, name='ai_chat_styling'),
    path('api/get-styling/', views.get_styling_advice_view, name='ai_get_styling'),
    ...
    #path('seller/delete-products/', views.delete_products_view, name='delete_products'),
    #path('seller/orders/', views.seller_orders_view, name='seller_orders'),
    path('seller/update-order-status/<int:order_id>/', views.update_order_status_view, name='update_order_status'),
